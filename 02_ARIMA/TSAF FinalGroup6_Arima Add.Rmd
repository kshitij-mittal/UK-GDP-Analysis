...
#### For best model, 1st differences are better option than using the original data.
...
#### As shown the auto.arima function, we confirmed again that 1st order diffencing is neccessary for the best arima model. 
...
estimate <- InvBoxCox((predict$mean), lambda = 0.2647119)
estimate
```
