...
``` 
From plot we see auto correlation at lag 1 and 2
...
```
EACF run for seasonal differenced data indicates using (1,2) and (2,2) models. 
We can run these also to check if we observe better model fits
