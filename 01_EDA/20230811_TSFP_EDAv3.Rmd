...
train_data <- window(ts_gdp, end = c(2010, 4))  # Training data until 2009 Q4
test_data <- window(ts_gdp, start = c(2011, 1)) # Test data from 2010 Q1 onwards
...
# Print RMSE
print(paste("AIC:", hw_add_damp$model$aicc))
print(paste("RMSE:", rmse_hw))
accuracy(forecast_values_hw_add, test_data)
```
